...
namespace T4Toolbox.VisualStudio.IntegrationTests
{
    ...
    public class TemplateErrorReporterTest : IntegrationTest
    {
        ...
        public TemplateErrorReporterTest()
        {
            ...
            {
                var componentModel = (IComponentModel)VsIdeTestHostContext.ServiceProvider.GetService(typeof(SComponentModel));
        ...
        public async Task TemplateErrorReporterCreatesErrorItemsForTemplateErrors()
        {
            await UIThreadDispatcher.InvokeAsync(delegate
            {
                ...
                {
                    TemplateErrorReporter.GetOrCreate(document.TextBuffer, VsIdeTestHostContext.ServiceProvider, this.documentFactory);
        ...
        public async Task TemplateErrorReporterIsNotGarbageCollectedBeforeTextDocumentIsDisposed()
        {
            await UIThreadDispatcher.InvokeAsync(delegate
            {
                ...
                using (ITextDocument document = this.documentFactory.CreateAndLoadTextDocument(tempFile, this.textContentType))
                {
                    var errorProvider = new WeakReference(TemplateErrorReporter.GetOrCreate(document.TextBuffer, VsIdeTestHostContext.ServiceProvider, this.documentFactory));
        ...
        public async Task TemplateErrorReporterCanBeGarbageCollectedAfterTextDocumentIsDisposed()
        {
            await UIThreadDispatcher.InvokeAsync(delegate
            {
                ...
                using (ITextDocument document = this.documentFactory.CreateAndLoadTextDocument(tempFile, this.textContentType))
                {
                    errorProvider = new WeakReference(TemplateErrorReporter.GetOrCreate(document.TextBuffer, VsIdeTestHostContext.ServiceProvider, this.documentFactory));
                }
        ...
        public async Task GetOrCreateStoresErrorProviderInBufferProperties()
        {
            await UIThreadDispatcher.InvokeAsync(delegate
            {
                ...
                using (ITextDocument document = this.documentFactory.CreateAndLoadTextDocument(tempFile, this.textContentType))
                {
                    var errorProvider = TemplateErrorReporter.GetOrCreate(document.TextBuffer, VsIdeTestHostContext.ServiceProvider, this.documentFactory);
        ...
        public async Task GetOrCreateDoesNotCreateNewTemplateErrorReporterIfItAlreadyExistsForTextBuffer()
        {
            ...
            await UIThreadDispatcher.InvokeAsync(delegate
            {
                ...
                using (ITextDocument document = this.documentFactory.CreateAndLoadTextDocument(tempFile, this.textContentType))
                {
                    var errorProvider1 = TemplateErrorReporter.GetOrCreate(document.TextBuffer, VsIdeTestHostContext.ServiceProvider, this.documentFactory);
                    var errorProvider2 = TemplateErrorReporter.GetOrCreate(document.TextBuffer, VsIdeTestHostContext.ServiceProvider, this.documentFactory);
