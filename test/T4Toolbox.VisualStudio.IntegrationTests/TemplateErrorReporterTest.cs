    ...
    public class TemplateErrorReporterTest : IntegrationTest
    {
        ...
        public async Task TemplateErrorReporterCreatesErrorItemsForTemplateErrors()
        {
            await UIThreadDispatcher.InvokeAsync(delegate
            {
                ...
                {
                    TemplateErrorReporter.GetOrCreate(document.TextBuffer, Microsoft.VisualStudio.Shell.ServiceProvider.GlobalProvider, this.documentFactory);
        ...
        public async Task TemplateErrorReporterIsNotGarbageCollectedBeforeTextDocumentIsDisposed()
        {
            await UIThreadDispatcher.InvokeAsync(delegate
            {
                ...
                using (ITextDocument document = this.documentFactory.CreateAndLoadTextDocument(tempFile, this.textContentType))
                {
                    var errorProvider = new WeakReference(TemplateErrorReporter.GetOrCreate(document.TextBuffer, Microsoft.VisualStudio.Shell.ServiceProvider.GlobalProvider, this.documentFactory));
        ...
        public async Task TemplateErrorReporterCanBeGarbageCollectedAfterTextDocumentIsDisposed()
        {
            await UIThreadDispatcher.InvokeAsync(delegate
            {
                ...
                using (ITextDocument document = this.documentFactory.CreateAndLoadTextDocument(tempFile, this.textContentType))
                {
                    errorProvider = new WeakReference(TemplateErrorReporter.GetOrCreate(document.TextBuffer, Microsoft.VisualStudio.Shell.ServiceProvider.GlobalProvider, this.documentFactory));
                }
        ...
        public async Task GetOrCreateStoresErrorProviderInBufferProperties()
        {
            await UIThreadDispatcher.InvokeAsync(delegate
            {
                ...
                using (ITextDocument document = this.documentFactory.CreateAndLoadTextDocument(tempFile, this.textContentType))
                {
                    var errorProvider = TemplateErrorReporter.GetOrCreate(document.TextBuffer, Microsoft.VisualStudio.Shell.ServiceProvider.GlobalProvider, this.documentFactory);
        ...
        public async Task GetOrCreateDoesNotCreateNewTemplateErrorReporterIfItAlreadyExistsForTextBuffer()
        {
            ...
            await UIThreadDispatcher.InvokeAsync(delegate
            {
                ...
                using (ITextDocument document = this.documentFactory.CreateAndLoadTextDocument(tempFile, this.textContentType))
                {
                    var errorProvider1 = TemplateErrorReporter.GetOrCreate(document.TextBuffer, Microsoft.VisualStudio.Shell.ServiceProvider.GlobalProvider, this.documentFactory);
                    var errorProvider2 = TemplateErrorReporter.GetOrCreate(document.TextBuffer, Microsoft.VisualStudio.Shell.ServiceProvider.GlobalProvider, this.documentFactory);
